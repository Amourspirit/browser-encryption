...
Client Side Encryption and Decryption\
  ...
  const injectEncryptionButtons = () => {
    ...
    let btnDecode = create('<button id="btndec" class="button btn_refresh btn-danger" onclick="dec();" data-toggle="tooltip" title="Decrypt Text"><span class="oi oi-lock-unlocked"></span> Decrypt</button>');
    let btnEncode = create('<button id="btnenc" class="button btn_refresh btn-primary" onclick="enc();" data-toggle="tooltip" title="Encrypt Text"><span class="oi oi-lock-locked"></span> Encrypt</button>');
